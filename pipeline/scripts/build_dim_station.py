...
if __name__ == "__main__":
    ...
    p.add_argument("--cache", type=Path, default=Path("../data/gtfs"))
    p.add_argument("--out", type=Path, default=Path("../data/dim_station.parquet"))
    ...
    usable = fetch_all(snaps, a.cache, a.workers)
    build(a.cache, a.out)
    print(f"built from {len(usable)}/{len(snaps)} snapshots")
